...
/* homepage.html.twig */
class __TwigTemplate_9a459f0ecfcb15e5e0e14137471b111c extends Template
{
    ...
    ";
        ...
        ";
        // line 10
        yield $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(CoreExtension::getAttribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 10, $this->source); })()), "plainPassword", [], "any", false, false, false, 10), 'row', ["label" => "Password"]);
        // line 12
        yield "
...
";
    ...
    {
        return array (  119 => 13,  116 => 12,  114 => 10,  110 => 9,  106 => 8,  100 => 6,  87 => 5,  64 => 3,  41 => 1,);
    }
...
{% block body %}
    ...
    {{ form_start(form) }}
        ...
        <button type=\"button\" class=\"btn\" onclick=\"window.location.href='{{ path('app_register') }}'\">
            Register
        </button>
        <button type=\"submit\" class=\"btn\">
            Login
